            ...
            <div className='py-5' style={{ background: "linear-gradient(135deg,#f3f4ff,#fdfbff)", minHeight: "100vh" }}>
                <div className='container'>
                    <div className='d-flex flex-wrap justify-content-between align-items-center'>
                        <div>
                            <h3 className='mb-1 d-flex align-items-center gap-2'>  <span className='d-inline-flex aligns-items-center justify-content-center rounded-3 border border-2' style={{ width: "40px", height: "40px", background: "#e0e7ff" }}>
                                <i className='fa-solid fa-user-graduate text-primary' /></span> <span>
                                    My Library Dashboard  </span></h3>
                        </div>
                        <div>
                            <p className='mt-3 rounded-pill bg-secondary text-white py-2 px-4 d-inline-block'>Welcome {studentUser?.full_name || "Guest"}</p>
                        </div>
                    </div>
                    {loading && (
                                ...
                                <div className='card border-0 shadow-sm h-100'>
                                    <div className='card-body d-flex flex-column '>
                                        <div className='d-flex justify-content-between aligns-item-center mb-3'>
                                            <div>
                                                <h6 className=' text-uppercase text-muted card-title mb-1 small'>Total Books
                                                    <h3 className='mb-0'>{states.total_books}</h3>
                                                </h6>
                                            </div>
                                            <div className='rounded-circle d-flex align-items-center justify-content-center' style={{ width: "40px", height: "40px", background: "#e0e7ff" }}>
                            ...
                            <div className='col-md-4'>
                                <div className='card border-0 shadow-sm h-100'
                                    ...
                                    <div className='card-body d-flex flex-column '>
                                        <div className='d-flex justify-content-between aligns-item-center mb-3'>
                                            <div>
                                                <h6 className=' text-uppercase text-muted card-title mb-1 small'>Pending Returns
                            ...
                            <div className='col-md-4'>
                                <div className='card border-0 shadow-sm h-100'>
                                    <div className='card-body d-flex flex-column '>
                                        <div className='d-flex justify-content-between aligns-item-center mb-3'>
                                            <div>
                                                <h6 className=' text-uppercase text-muted card-title mb-1 small'>Total Books Issued
